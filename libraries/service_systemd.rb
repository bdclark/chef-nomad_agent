...
module NomadAgentCookbook
  class NomadAgentServiceSystemd < NomadAgentService
    use_automatic_resource_name

    provides :nomad_agent_service, platform: 'fedora'
    ...
    provides :nomad_agent_service, platform_family: 'suse' do |node|
    ...
    action_class.class_eval do
      def service_file
        "/etc/systemd/system/#{nomad_service_name}.service"
      end
